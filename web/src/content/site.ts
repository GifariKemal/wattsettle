...
export const site = {
  ...
  event: {
    ...
    submission: "1–30 September 2026",
...
export const nav = {
  links: [
    ...
    { href: "#opsi", label: "Opsi 5 & 6" },
    { href: "#menang", label: "Kenapa Menang" },
...
export const hero = {
  ...
  stats: [
    { value: "90", suffix: "/100", label: "skor benchmark dari 6 opsi" },
    { value: "84", suffix: "–90%", label: "peluang nominasi" },
    { value: "45", suffix: "–58%", label: "peluang juara-1 in-track" },
  ],
} as const;
