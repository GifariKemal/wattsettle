...
export const probability = {
  ...
  lead:
    "Setelah semua fix: nominasi 84–90%, juara-1 in-track 45–58% — bukan >90%. Angka ini sudah di-red-team; sisanya faktor di luar kendali. Yang kita lakukan: dorong sekeras mungkin.",
  stats: [
    { value: "90", suffix: "", label: "skor benchmark /100", accent: "watt" },
    { value: "84", suffix: "–90%", label: "peluang nominasi", accent: "flow" },
    { value: "45", suffix: "–58%", label: "juara 1 in-track", accent: "gold" },
