...
```mermaid
flowchart LR
  A["1. MASALAH<br/>kenapa ini harus ada"] --> B["2. WHAT<br/>kalau dibiarkan, rugi apa"]
  B --> C["3. HOW<br/>solusi plus pembeda"]
  C --> D["4. END TO END<br/>user awal, fitur, untung"]
  D --> E["5. TEKNIS<br/>apa, kenapa cocok, beda"]
  E --> F["6. LIVE DEMO<br/>A sampai Z, tanpa login"]
  F --> G["7. WHY NOW<br/>timing plus kompetitor"]
```
...
<div align="center">
<sub>Arsip materi pihak ketiga untuk keperluan belajar. Slide milik Dev Web3 Jogja.</sub>
</div>
